...
export const ThemeToggleButton = ({
  ...
  return (
    <Button
      ...
      onClick={handleClick}
      className={cn(
        "relative overflow-hidden transition-all hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-gray-700 rounded-full",
        showLabel && "gap-2",
        className,
      )}
      aria-label={`Switch to ${theme === "light" ? "dark" : "light"} theme`}
    >
      <div className="w-8 h-8 rounded-full border border-gray-200 hover:border-gray-300 dark:border-gray-700 dark:hover:border-gray-600 flex items-center justify-center transition-all hover:text-gray-700 hover:bg-gray-200 dark:hover:bg-gray-800/50">
        {theme === "light" ? (
