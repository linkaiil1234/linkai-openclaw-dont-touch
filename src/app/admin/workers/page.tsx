...
const INITIAL_WORKERS: Worker[] = [
  { id: 'w-1', name: 'Theta (Audio)', role: 'Analyst', status: 'idle', capabilities: ['transcribe', 'sentiment'] },
  { id: 'w-2', name: 'Sigma (Coder)', role: 'Engineer', status: 'busy', currentTask: 'Refactor Wizard UI', capabilities: ['react', 'nextjs', 'git'] },
  { id: 'w-3', name: 'Omega (Research)', role: 'Scout', status: 'offline', capabilities: ['brave-search', 'scrape'] },
];

const INITIAL_TASKS: Task[] = [
  { id: 't-1', title: 'Analyze Competitor Pricing', status: 'pending' },
  { id: 't-2', title: 'Fix CSS Mobile Bug', assignedTo: 'w-2', status: 'in-progress' },
  { id: 't-3', title: 'Summarize Weekly Podcast', status: 'pending' },
];
